"""
Django settings for Vns_Service project.
...
WSGI_APPLICATION = 'Vns_Service.wsgi.application'
...
DEFAULT_FROM_EMAIL = "info@VNS_SERVICE_SATATION.com"
DOMAIN = env("DOMAIN")
